...
<body>
		<form method="post">
				...
				<fieldset>
						...
						<p>
								<input type="radio" name="actionscript" value="creer" id="creer" checked /><label for="creer">Creer</label><br /> <input type="radio" name="actionscript" value="modifier"
				...
				<div id="creerscript">
						<fieldset>
								...
								<br /> <br /> <label for="libellescript">Libellé : <span class="requis">*</span></label> <input type="libellescript" id="libellescript" name="libellescript" value=""
		...
		<div id="modifierscript">
				<fieldset>
						...
						<label for="selectionscript">Sélectionnez un script :</label> </br> </br> <select name="selectionscript" id="selectionscript">
								<c:forEach var="entry" items="${session.listeScripts}">
										<option value="<c:out value="${entry.key}"/>"><c:out value="${entry.value.libelle}" /></option>
								</c:forEach>
						</select> <br /> <br /> <input type="submit" value="Modifier le script" class="sansLabel" id="submit" /> <input type="reset" value="Effacer saisie" id="reset" />
				</fieldset>
